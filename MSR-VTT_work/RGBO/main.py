...
def main(cfg):
    ...
    if cfg.interruption is True:
        model.load_state_dict(torch.load('./results/model_param/msrvtt/training/train_26.pth'))
    ...
    #     print('--- Validation ---')
    #     if cfg.dataset_name == 'msvd':
    #         val_loss, max_meteor, ave_meteor = validation(model, val_loader, loss_compute, lr_scheduler,epoch, TBoard,
    ...
    print('----- Test Start -----')
    print(f'Best epoch ({ave_best_epoch})')

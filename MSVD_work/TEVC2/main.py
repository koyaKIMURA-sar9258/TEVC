...
def main(cfg):
    ...
    if cfg.interruption is True:
        model.load_state_dict(torch.load('./results/model_param/msvd/training/train_38.pth'))
    ...
    print('----- Test Start -----')
    max_metrics , ave_metrics = test(model, test_loader, cfg.dataset_name, 0, TBoard, vocab, cfg.use_flow, max_best_epoch)
